...
struct snd_seq_user_client {
    struct file *__attribute__((recursive)) file;	/* file struct of client */ // MJR
	/* ... */
...
struct snd_seq_client {
	...
	union {
            struct snd_seq_user_client __attribute__((recursive)) user; // MJR
		struct snd_seq_kernel_client kernel;
	} __attribute__((recursive)) data; // MJR
};
