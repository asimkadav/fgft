...
struct snd_seq_timer {
    ...
    struct snd_timer_instance	*__attribute__((recursive)) timeri;	/* timer instance */ // MJR
	unsigned int		ticks;
...
/* */
/* static MJR */ inline void snd_seq_timer_update_tick(struct snd_seq_timer_tick *tick,
...
/* static MJR */ inline int snd_seq_compare_tick_time(snd_seq_tick_time_t *a, snd_seq_tick_time_t *b)
{
	/* compare ticks */
	return (*a >= *b);
}

/* static MJR */ inline int snd_seq_compare_real_time(snd_seq_real_time_t *a, snd_seq_real_time_t *b)
{
	/* compare real time */
...
/* static MJR */ inline void snd_seq_sanity_real_time(snd_seq_real_time_t *tm)
{
...
/* increment timestamp */
/* static MJR */ inline void snd_seq_inc_real_time(snd_seq_real_time_t *tm, snd_seq_real_time_t *inc)
{
...
/* static MJR */ inline void snd_seq_inc_time_nsec(snd_seq_real_time_t *tm, unsigned long nsec)
{
	tm->tv_nsec  += nsec;
	snd_seq_sanity_real_time(tm);
}
