 ...
 * prototypes
 */
/* static MJR */ void note_event(struct snd_midi_event *dev, struct snd_seq_event *ev);
/* static MJR */ void one_param_ctrl_event(struct snd_midi_event *dev, struct snd_seq_event *ev);
/* static MJR */ void pitchbend_ctrl_event(struct snd_midi_event *dev, struct snd_seq_event *ev);
/* static MJR */ void two_param_ctrl_event(struct snd_midi_event *dev, struct snd_seq_event *ev);
/* static MJR */ void one_param_event(struct snd_midi_event *dev, struct snd_seq_event *ev);
/* static MJR */ void songpos_event(struct snd_midi_event *dev, struct snd_seq_event *ev);
/* static MJR */ void note_decode(struct snd_seq_event *ev, unsigned char *buf);
/* static MJR */ void one_param_decode(struct snd_seq_event *ev, unsigned char *buf);
/* static MJR */ void pitchbend_decode(struct snd_seq_event *ev, unsigned char *buf);
/* static MJR */ void two_param_decode(struct snd_seq_event *ev, unsigned char *buf);
/* static MJR */ void songpos_decode(struct snd_seq_event *ev, unsigned char *buf);
...
/* static MJR */ int extra_decode_ctrl14(struct snd_midi_event *dev, unsigned char *buf, int len,
			       struct snd_seq_event *ev);
/* static MJR */ int extra_decode_xrpn(struct snd_midi_event *dev, unsigned char *buf, int count,
			     struct snd_seq_event *ev);
 ...
 * initialize record
 */
/* static MJR */ inline void reset_encode(struct snd_midi_event *dev)
{
	dev->read = 0;
	dev->qlen = 0;
	dev->type = ST_INVALID;
...
/* static MJR */ int extra_decode_ctrl14(struct snd_midi_event *dev, unsigned char *buf,
...
/* static MJR */ int extra_decode_xrpn(struct snd_midi_event *dev, unsigned char *buf,
			     int count, struct snd_seq_event *ev)
{
	unsigned char cmd;
	char *cbytes;
...
// EXPORT_SYMBOL(snd_midi_event_new); // MJR
// EXPORT_SYMBOL(snd_midi_event_free); // MJR
// EXPORT_SYMBOL(snd_midi_event_reset_encode); // MJR
// EXPORT_SYMBOL(snd_midi_event_reset_decode); // MJR
// EXPORT_SYMBOL(snd_midi_event_no_status); // MJR
// EXPORT_SYMBOL(snd_midi_event_encode); // MJR
// EXPORT_SYMBOL(snd_midi_event_encode_byte); // MJR
// EXPORT_SYMBOL(snd_midi_event_decode); // MJR

/* static MJR */ int /* __init MJR */  alsa_seq_midi_event_init(void)
{
	return 0;
}

/* static MJR */ void __exit alsa_seq_midi_event_exit(void)
{
}

// module_init(alsa_seq_midi_event_init) // MJR
// module_exit(alsa_seq_midi_event_exit) // MJR
