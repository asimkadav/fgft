...
/* static MJR */ int queue_list_add(struct snd_seq_queue *q)
{
	int i;
	unsigned long flags;
...
/* static MJR */ struct snd_seq_queue *queue_list_remove(int id, int client)
{
...
/* static MJR */ struct snd_seq_queue *queue_new(int owner, int locked)
{
	struct snd_seq_queue *q;
...
/* static MJR */ void queue_delete(struct snd_seq_queue *q)
{
...
/* setup queues */
int /* __init MJR */  snd_seq_queues_init(void)
{
	/*
...
/* static MJR */ inline int check_access(struct snd_seq_queue *q, int client)
{
 ...
 */
/* static MJR */ int queue_access_lock(struct snd_seq_queue *q, int client)
{
	unsigned long flags;
	int access_ok;
...
/* unlock the queue */
/* static MJR */ inline void queue_access_unlock(struct snd_seq_queue *q)
{
	unsigned long flags;
 ...
 */
/* static MJR */ void queue_broadcast_event(struct snd_seq_queue *q, struct snd_seq_event *ev,
				  int atomic, int hop)
{
 ...
 */
/* static MJR */ void snd_seq_queue_process_event(struct snd_seq_queue *q,
