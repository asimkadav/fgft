...
// EXPORT_SYMBOL(snd_oss_info_register); // MJR

/* static MJR */ int snd_sndstat_show_strings(struct snd_info_buffer *buf, char *id, int dev)
{
	int idx, ok = -1;
	char *str;
...
/* static MJR */ void snd_sndstat_proc_read(struct snd_info_entry *entry,
