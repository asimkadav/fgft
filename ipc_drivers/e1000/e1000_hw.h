...
struct e1000_hw {
	//u8 __iomem		*hw_addr; //  ASIM
	u8 * __attribute__((noderef, address_space(2))) hw_addr; // ASIM 
	//u8  __iomem		*flash_address; // ASIM
	u8 * __attribute__((noderef, address_space(2))) flash_address; // ASIM
