...
UNUSUAL_DEV(  0x05c6, 0x1000, 0x0000, 0x9999, //MJR      Commented since we do not support these files
		"Option N.V.", //MJR
		"Mass Storage",     //MJR
		US_SC_DEVICE, US_PR_DEVICE, option_ms_init, //MJR
		0),
*/
...
/* iCON 225 
UNUSUAL_DEV(  0x0af0, 0x6971, 0x0000, 0x9999, //        Commented since we do not support these drivers MJR
		"Option N.V.",                          // MJR
		"Mass Storage",                           //  MJR
		US_SC_DEVICE, US_PR_DEVICE, option_ms_init, //   MJR
		0),                                           //    MJR
 ...
 * device.
 *
UNUSUAL_DEV(  0x1199, 0x0fff, 0x0000, 0x9999,  //MJR
		"Sierra Wireless", //MJR
		"USB MMC Storage",      //MJR
		US_SC_DEVICE, US_PR_DEVICE, sierra_ms_init, //MJR
		0),//MJR
Commented since we do not support these drivers MJR
*/
