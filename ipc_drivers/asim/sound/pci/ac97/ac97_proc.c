...
/* static MJR */ void snd_ac97_proc_read_functions(struct snd_ac97 *ac97, struct snd_info_buffer *buffer)
{
...
/* static MJR */ void snd_ac97_proc_read_main(struct snd_ac97 *ac97, struct snd_info_buffer *buffer, int subidx)
{
	char name[64];
...
/* static MJR */ void snd_ac97_proc_read(struct snd_info_entry *entry, struct snd_info_buffer *buffer)
{
...
/* static MJR */ void snd_ac97_proc_regs_write(struct snd_info_entry *entry, struct snd_info_buffer *buffer)
{
	struct snd_ac97 *ac97 = entry->private_data;
	char line[64];
...
/* static MJR */ void snd_ac97_proc_regs_read_main(struct snd_ac97 *ac97, struct snd_info_buffer *buffer, int subidx)
{
	int reg, val;
...
/* static MJR */ void snd_ac97_proc_regs_read(struct snd_info_entry *entry, 
