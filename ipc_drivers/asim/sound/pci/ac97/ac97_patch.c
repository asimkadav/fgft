...
/* static MJR */ int patch_build_controls(struct snd_ac97 * ac97, const struct snd_kcontrol_new *controls, int count)
{
	int idx, err;
...
/* static MJR */ void reset_tlv(struct snd_ac97 *ac97, const char *name,
...
/* static MJR */ int ac97_update_bits_page(struct snd_ac97 *ac97, unsigned short reg, unsigned short mask, unsigned short value, unsigned short page)
{
 ...
 */
/* static MJR */ int ac97_enum_text_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo,
...
/* static MJR */ int ac97_surround_jack_mode_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
	static const char *texts[] = { "Shared", "Independent" };
	return ac97_enum_text_info(kcontrol, uinfo, texts, 2);
}

/* static MJR */ int ac97_surround_jack_mode_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ int ac97_surround_jack_mode_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int ac97_channel_mode_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int ac97_channel_mode_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int ac97_channel_mode_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ inline int is_surround_on(struct snd_ac97 *ac97)
{
	return ac97->channel_mode >= 1;
}

/* static MJR */ inline int is_clfe_on(struct snd_ac97 *ac97)
{
	return ac97->channel_mode >= 2;
}

/* system has shared jacks with surround out enabled */
/* static MJR */ inline int is_shared_surrout(struct snd_ac97 *ac97)
{
	return !ac97->indep_surround && is_surround_on(ac97);
}

/* system has shared jacks with center/lfe out enabled */
/* static MJR */ inline int is_shared_clfeout(struct snd_ac97 *ac97)
{
	return !ac97->indep_surround && is_clfe_on(ac97);
}

/* system has shared jacks with line in enabled */
/* static MJR */ inline int is_shared_linein(struct snd_ac97 *ac97)
{
	return !ac97->indep_surround && !is_surround_on(ac97);
}

/* system has shared jacks with mic in enabled */
/* static MJR */ inline int is_shared_micin(struct snd_ac97 *ac97)
{
	return !ac97->indep_surround && !is_clfe_on(ac97);
}

/* static MJR */ inline int alc850_is_aux_back_surround(struct snd_ac97 *ac97)
{
...
/* static MJR */ int snd_ac97_ymf7x3_info_speaker(struct snd_kcontrol *kcontrol,
...
/* static MJR */ int snd_ac97_ymf7x3_get_speaker(struct snd_kcontrol *kcontrol,
...
/* static MJR */ int snd_ac97_ymf7x3_put_speaker(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ymf7x3_spdif_source_info(struct snd_kcontrol *kcontrol,
					     struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_ymf7x3_spdif_source_get(struct snd_kcontrol *kcontrol,
					    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ymf7x3_spdif_source_put(struct snd_kcontrol *kcontrol,
					    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int patch_yamaha_ymf7x3_3d(struct snd_ac97 *ac97)
{
	struct snd_kcontrol *kctl;
	int err;
...
/* static MJR */ int patch_yamaha_ymf743_build_spdif(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_yamaha_ymf743(struct snd_ac97 *ac97)
{
...
/* static MJR */ int snd_ac97_ymf753_spdif_output_pin_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_ymf753_spdif_output_pin_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ymf753_spdif_output_pin_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int patch_yamaha_ymf753_post_spdif(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_yamaha_ymf753(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_wolfson_wm9703_specific(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_wolfson03(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_wolfson_wm9704_specific(struct snd_ac97 * ac97)
{
	int err, i;
...
/* static MJR */ int patch_wolfson04(struct snd_ac97 * ac97)
{
	/* WM9704M/9704Q */
...
/* static MJR */ int patch_wolfson_wm9705_specific(struct snd_ac97 * ac97)
{
	int err, i;
	for (i = 0; i < ARRAY_SIZE(wm97xx_snd_ac97_controls); i++) {
		if ((err = snd_ctl_add(ac97->bus->card, snd_ac97_cnew(&wm97xx_snd_ac97_controls[i], ac97))) < 0)
...
/* static MJR */ int patch_wolfson05(struct snd_ac97 * ac97)
{
	/* WM9705, WM9710 */
...
/* static MJR */ int patch_wolfson_wm9711_specific(struct snd_ac97 * ac97)
{
	int err, i;
...
/* static MJR */ int patch_wolfson11(struct snd_ac97 * ac97)
{
	/* WM9711, WM9712 */
...
/* static MJR */ int patch_wolfson_wm9713_3d (struct snd_ac97 * ac97)
{
	int err, i;
...
/* static MJR */ int patch_wolfson_wm9713_specific(struct snd_ac97 * ac97)
{
	int err, i;
...
#ifdef CONFIG_PM
/* static MJR */ void patch_wolfson_wm9713_suspend (struct snd_ac97 * ac97)
{
	snd_ac97_write_cache(ac97, AC97_EXTENDED_MID, 0xfeff);
	snd_ac97_write_cache(ac97, AC97_EXTENDED_MSTATUS, 0xffff);
}

/* static MJR */ void patch_wolfson_wm9713_resume (struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_wolfson13(struct snd_ac97 * ac97)
{
	/* WM9713, WM9714 */
 ...
 * Tritech codec
 */
/* static MJR */ int patch_tritech_tr28028(struct snd_ac97 * ac97)
{
 ...
 */
/* static MJR */ int patch_sigmatel_stac9700_3d(struct snd_ac97 * ac97)
{
	struct snd_kcontrol *kctl;
	int err;
...
/* static MJR */ int patch_sigmatel_stac9708_3d(struct snd_ac97 * ac97)
{
	struct snd_kcontrol *kctl;
	int err;
...
/* static MJR */ int patch_sigmatel_stac97xx_specific(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_sigmatel_stac9700(struct snd_ac97 * ac97)
{
	ac97->build_ops = &patch_sigmatel_stac9700_ops;
	return 0;
}

/* static MJR */ int snd_ac97_stac9708_put_bias(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	int err;
...
/* static MJR */ int patch_sigmatel_stac9708_specific(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_sigmatel_stac9708(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_sigmatel_stac9721(struct snd_ac97 * ac97)
{
	ac97->build_ops = &patch_sigmatel_stac9700_ops;
...
/* static MJR */ int patch_sigmatel_stac9744(struct snd_ac97 * ac97)
{
	// patch for SigmaTel
	ac97->build_ops = &patch_sigmatel_stac9700_ops;
	snd_ac97_write_cache(ac97, AC97_SIGMATEL_CIC1, 0xabba);
...
/* static MJR */ int patch_sigmatel_stac9756(struct snd_ac97 * ac97)
{
	// patch for SigmaTel
	ac97->build_ops = &patch_sigmatel_stac9700_ops;
	snd_ac97_write_cache(ac97, AC97_SIGMATEL_CIC1, 0xabba);
...
/* static MJR */ int snd_ac97_stac9758_output_jack_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_stac9758_output_jack_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int snd_ac97_stac9758_output_jack_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	int shift = kcontrol->private_value;
	unsigned short val;
...
/* static MJR */ int snd_ac97_stac9758_input_jack_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_stac9758_input_jack_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	int shift = kcontrol->private_value;
	unsigned short val;
...
/* static MJR */ int snd_ac97_stac9758_input_jack_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	int shift = kcontrol->private_value;
...
/* static MJR */ int snd_ac97_stac9758_phonesel_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_stac9758_phonesel_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int snd_ac97_stac9758_phonesel_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int patch_sigmatel_stac9758_specific(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_sigmatel_stac9758(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_cirrus_build_spdif(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_cirrus_spdif(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_cirrus_cs4299(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_conexant_build_spdif(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_conexant(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_cx20551(struct snd_ac97 *ac97)
{
 ...
 */
#ifdef CONFIG_PM
/* static MJR */ void ad18xx_resume(struct snd_ac97 *ac97)
{
...
/* static MJR */ void ad1888_resume(struct snd_ac97 *ac97)
{
	ad18xx_resume(ac97);
...
static const struct snd_ac97_res_table ad1819_restbl[] = {
	...
	{ AC97_AUX, 0x9f1f },
	{ AC97_PCM, 0x9f1f },
	{ 0, 0 } /* terminator */ // MJR Added 0, 0 due to CIL bug
};

/* static MJR */ int patch_ad1819(struct snd_ac97 * ac97)
{
	unsigned short scfg;
...
/* static MJR */ unsigned short patch_ad1881_unchained(struct snd_ac97 * ac97, int idx, unsigned short mask)
{
	unsigned short val;
...
/* static MJR */ int patch_ad1881_chained1(struct snd_ac97 * ac97, int idx, unsigned short codec_bits)
{
...
/* static MJR */ void patch_ad1881_chained(struct snd_ac97 * ac97, int unchained_idx, int cidx1, int cidx2)
{
	// already detected?
...
/* static MJR */ int patch_ad1881(struct snd_ac97 * ac97)
{
...
/* static MJR */ const DECLARE_TLV_DB_SCALE(db_scale_6bit_6db_max, -8850, 150, 0);

/* static MJR */ int patch_ad1885_specific(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_ad1885(struct snd_ac97 * ac97)
{
	patch_ad1881(ac97);
...
/* static MJR */ int patch_ad1886_specific(struct snd_ac97 * ac97)
{
	reset_tlv(ac97, "Headphone Playback Volume",
		  db_scale_6bit_6db_max);
	return 0;
...
/* static MJR */ int patch_ad1886(struct snd_ac97 * ac97)
{
	patch_ad1881(ac97);
...
/* static MJR */ int snd_ac97_ad198x_spdif_source_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
	static char *texts[2] = { "AC-Link", "A/D Converter" };
...
/* static MJR */ int snd_ac97_ad198x_spdif_source_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ad198x_spdif_source_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int patch_ad198x_post_spdif(struct snd_ac97 * ac97)
{
...
/* static MJR */ int check_list(struct snd_ac97 *ac97, const unsigned int *list)
{
...
/* static MJR */ int patch_ad1981a_specific(struct snd_ac97 * ac97)
{
...
/* static MJR */ void check_ad1981_hp_jack_sense(struct snd_ac97 *ac97)
{
...
/* static MJR */ int patch_ad1981a(struct snd_ac97 *ac97)
{
	patch_ad1881(ac97);
...
/* static MJR */ int patch_ad1981b_specific(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_ad1981b(struct snd_ac97 *ac97)
{
	patch_ad1881(ac97);
...
/* static MJR */ int snd_ac97_ad1888_lohpsel_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ad1888_lohpsel_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ad1888_downmix_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_ad1888_downmix_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ad1888_downmix_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ void ad1888_update_jacks(struct snd_ac97 *ac97)
{
...
/* static MJR */ int patch_ad1888_specific(struct snd_ac97 *ac97)
{
	if (!ac97->spec.ad18xx.lo_as_master) {
...
/* static MJR */ int patch_ad1888(struct snd_ac97 * ac97)
{
	unsigned short misc;
...
/* static MJR */ int patch_ad1980_specific(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_ad1980(struct snd_ac97 * ac97)
{
	patch_ad1888(ac97);
...
/* static MJR */ int snd_ac97_ad1985_vrefout_info(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_ad1985_vrefout_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ int snd_ac97_ad1985_vrefout_put(struct snd_kcontrol *kcontrol, 
				       struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ void ad1985_update_jacks(struct snd_ac97 *ac97)
{
...
/* static MJR */ int patch_ad1985_specific(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_ad1985(struct snd_ac97 * ac97)
{
	unsigned short misc;
...
/* static MJR */ int snd_ac97_ad1986_lososel_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ad1986_lososel_put(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	int ret0;
...
/* static MJR */ int snd_ac97_ad1986_spread_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_ad1986_spread_put(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	int ret0;
...
/* static MJR */ int snd_ac97_ad1986_miclisel_get(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int snd_ac97_ad1986_miclisel_put(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int snd_ac97_ad1986_vrefout_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ int snd_ac97_ad1986_vrefout_put(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short cval;
...
/* static MJR */ void ad1986_update_jacks(struct snd_ac97 *ac97)
{
...
/* static MJR */ int patch_ad1986_specific(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_ad1986(struct snd_ac97 * ac97)
{
	patch_ad1881(ac97);
 ...
 */
/* static MJR */ int patch_alc203(struct snd_ac97 *ac97)
{
 ...
 */
/* static MJR */ void alc650_update_jacks(struct snd_ac97 *ac97)
{
	int shared;
...
/* static MJR */ const DECLARE_TLV_DB_SCALE(db_scale_5bit_3db_max, -4350, 150, 0);

/* static MJR */ int patch_alc650_specific(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_alc650(struct snd_ac97 * ac97)
{
	unsigned short val;
...
/* static MJR */ void alc655_update_jacks(struct snd_ac97 *ac97)
{
	int shared;
...
/* static MJR */ int alc655_iec958_route_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int alc655_iec958_route_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int alc655_iec958_route_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int patch_alc655_specific(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_alc655(struct snd_ac97 * ac97)
{
	unsigned int val;
...
/* static MJR */ void alc850_update_jacks(struct snd_ac97 *ac97)
{
	int shared;
...
/* static MJR */ int patch_alc850_specific(struct snd_ac97 *ac97)
{
	int err;
...
/* static MJR */ int patch_alc850(struct snd_ac97 *ac97)
{
 ...
 */
/* static MJR */ void cm9738_update_jacks(struct snd_ac97 *ac97)
{
	/* shared Line-In / Surround Out */
...
/* static MJR */ int patch_cm9738_specific(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_cm9738(struct snd_ac97 * ac97)
{
...
/* static MJR */ int snd_ac97_cmedia_spdif_playback_source_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_cmedia_spdif_playback_source_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
	unsigned short val;
...
/* static MJR */ int snd_ac97_cmedia_spdif_playback_source_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ void cm9739_update_jacks(struct snd_ac97 *ac97)
{
	/* shared Line-In / Surround Out */
...
/* static MJR */ int patch_cm9739_specific(struct snd_ac97 * ac97)
{
	return patch_build_controls(ac97, snd_ac97_cm9739_controls, ARRAY_SIZE(snd_ac97_cm9739_controls));
}

/* static MJR */ int patch_cm9739_post_spdif(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_cm9739(struct snd_ac97 * ac97)
{
	unsigned short val;
...
/* static MJR */ void cm9761_update_jacks(struct snd_ac97 *ac97)
{
	/* FIXME: check the bits for each model
	 *        model 83 is confirmed to work
	 */
    static unsigned short (__attribute__((noderef, address_space(2))) surr_on)[3][2] = { // MJR
		{ 0x0008, 0x0000 }, /* 9761-78 & 82 */
		{ 0x0000, 0x0008 }, /* 9761-82 rev.B */
		{ 0x0000, 0x0008 }, /* 9761-83 */
	};
    static unsigned short (__attribute__((noderef, address_space(2))) clfe_on)[3][2] = { // MJR
		{ 0x0000, 0x1000 }, /* 9761-78 & 82 */
		{ 0x1000, 0x0000 }, /* 9761-82 rev.B */
		{ 0x0000, 0x1000 }, /* 9761-83 */
	};
    static unsigned short (__attribute__((noderef, address_space(2))) surr_shared)[3][2] = { // MJR
		{ 0x0000, 0x0400 }, /* 9761-78 & 82 */
		{ 0x0000, 0x0400 }, /* 9761-82 rev.B */
		{ 0x0000, 0x0400 }, /* 9761-83 */
	};
    static unsigned short (__attribute__((noderef, address_space(2))) clfe_shared)[3][2] = { // MJR
...
/* static MJR */ int cm9761_spdif_out_source_info(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int cm9761_spdif_out_source_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int cm9761_spdif_out_source_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_ac97 *ac97 = snd_kcontrol_chip(kcontrol);
...
/* static MJR */ int patch_cm9761_post_spdif(struct snd_ac97 * ac97)
{
	return patch_build_controls(ac97, snd_ac97_cm9761_controls_spdif, ARRAY_SIZE(snd_ac97_cm9761_controls_spdif));
}

/* static MJR */ int patch_cm9761_specific(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_cm9761(struct snd_ac97 *ac97)
{
	unsigned short val;
...
/* static MJR */ int patch_cm9780_specific(struct snd_ac97 *ac97)
{
...
/* static MJR */ int patch_cm9780(struct snd_ac97 *ac97)
{
	unsigned short val;
...
/* static MJR */ struct snd_kcontrol *snd_ac97_find_mixer_ctl(struct snd_ac97 *ac97,
						    const char *name)
{
...
/* static MJR */ int snd_ac97_add_vmaster(struct snd_ac97 *ac97, char *name,
...
/* static MJR */ int patch_vt1616_specific(struct snd_ac97 * ac97)
{
	struct snd_kcontrol *kctl;
	int err;
...
/* static MJR */ int patch_vt1616(struct snd_ac97 * ac97)
{
...
/* static MJR */ int snd_ac97_vt1617a_smart51_info(struct snd_kcontrol *kcontrol,
					 struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_vt1617a_smart51_get(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
	ushort usSM51, usMS;  
...
/* static MJR */ int snd_ac97_vt1617a_smart51_put(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ int patch_vt1617a(struct snd_ac97 * ac97)
{
	int err = 0;
	int val;
...
/* static MJR */ int snd_ac97_vt1618_UAJ_info(struct snd_kcontrol *kcontrol,
				    struct snd_ctl_elem_info *uinfo)
{
 ...
 */
/* static MJR */ int snd_ac97_vt1618_UAJ_get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ int snd_ac97_vt1618_UAJ_put(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ int snd_ac97_vt1618_aux_info(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_info *uinfo)
{
...
/* static MJR */ int snd_ac97_vt1618_aux_get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.enumerated.item[0] =
...
/* static MJR */ int snd_ac97_vt1618_aux_put(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
...
/* static MJR */ int patch_vt1618(struct snd_ac97 *ac97)
{
...
/*
 */
/* static MJR */ void it2646_update_jacks(struct snd_ac97 *ac97)
{
	/* shared Line-In / Surround Out */
...
/* static MJR */ int patch_it2646_specific(struct snd_ac97 * ac97)
{
	int err;
...
/* static MJR */ int patch_it2646(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_si3036_specific(struct snd_ac97 * ac97)
{
	int idx, err;
...
/* static MJR */ int mpatch_si3036(struct snd_ac97 * ac97)
{
...
/* static MJR */ int patch_lm4550(struct snd_ac97 *ac97)
{
...
/* static MJR */ int patch_ucb1400_specific(struct snd_ac97 * ac97)
{
	int idx, err;
...
/* static MJR */ int patch_ucb1400(struct snd_ac97 * ac97)
{
