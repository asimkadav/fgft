 ...
 */
/* static MJR */ void snd_virmidi_init_event(struct snd_virmidi *vmidi,
 ...
 */
/* static MJR */ int snd_virmidi_dev_receive_event(struct snd_virmidi_dev *rdev,
					 struct snd_seq_event *ev)
{
 ...
 */
/* static MJR */ int snd_virmidi_event_input(struct snd_seq_event *ev, int direct,
 ...
 */
/* static MJR */ void snd_virmidi_input_trigger(struct snd_rawmidi_substream *substream, int up)
{
 ...
 */
/* static MJR */ void snd_virmidi_output_trigger(struct snd_rawmidi_substream *substream, int up)
{
	struct snd_virmidi *vmidi = substream->runtime->private_data;
	int count, res;
 ...
 */
/* static MJR */ int snd_virmidi_input_open(struct snd_rawmidi_substream *substream)
{
 ...
 */
/* static MJR */ int snd_virmidi_output_open(struct snd_rawmidi_substream *substream)
{
	struct snd_virmidi_dev *rdev = substream->rmidi->private_data;
	struct snd_rawmidi_runtime *runtime = substream->runtime;
	struct snd_virmidi *vmidi;
 ...
 */
/* static MJR */ int snd_virmidi_input_close(struct snd_rawmidi_substream *substream)
{
	struct snd_virmidi *vmidi = substream->runtime->private_data;
 ...
 */
/* static MJR */ int snd_virmidi_output_close(struct snd_rawmidi_substream *substream)
{
	struct snd_virmidi *vmidi = substream->runtime->private_data;
	snd_midi_event_free(vmidi->parser);
	substream->runtime->private_data = NULL;
 ...
 */
/* static MJR */ int snd_virmidi_subscribe(void *private_data,
 ...
 */
/* static MJR */ int snd_virmidi_unsubscribe(void *private_data,
				   struct snd_seq_port_subscribe *info)
{
	struct snd_virmidi_dev *rdev;
 ...
 */
/* static MJR */ int snd_virmidi_use(void *private_data,
			   struct snd_seq_port_subscribe *info)
{
	struct snd_virmidi_dev *rdev;
 ...
 */
/* static MJR */ int snd_virmidi_unuse(void *private_data,
			     struct snd_seq_port_subscribe *info)
{
	struct snd_virmidi_dev *rdev;
 ...
 */
/* static MJR */ int snd_virmidi_dev_attach_seq(struct snd_virmidi_dev *rdev)
{
	int client;
 ...
 */
/* static MJR */ void snd_virmidi_dev_detach_seq(struct snd_virmidi_dev *rdev)
{
	if (rdev->client >= 0) {
 ...
 * register the device
 */
/* static MJR */ int snd_virmidi_dev_register(struct snd_rawmidi *rmidi)
{
	...
	case SNDRV_VIRMIDI_SEQ_ATTACH:
		...
		break;
	default:
		snd_mprintk(KERN_ERR "seq_mode is not set: %d\n", rdev->seq_mode); // MJR
		return -EINVAL;
	}
	return 0;
}
 ...
 */
/* static MJR */ int snd_virmidi_dev_unregister(struct snd_rawmidi *rmidi)
{
	struct snd_virmidi_dev *rdev = rmidi->private_data;
 ...
 * free device
 */
/* static MJR */ void snd_virmidi_free(struct snd_rawmidi *rmidi)
{
	struct snd_virmidi_dev *rdev = rmidi->private_data;
	kfree(rdev);
}
...
/* static MJR */ int /* __init MJR */  alsa_virmidi_init(void)
{
	return 0;
}

/* static MJR */ void __exit alsa_virmidi_exit(void)
{
}

// module_init(alsa_virmidi_init) // MJR
// module_exit(alsa_virmidi_exit) // MJR

// EXPORT_SYMBOL(snd_virmidi_new); // MJR
