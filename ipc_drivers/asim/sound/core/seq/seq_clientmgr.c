 ...
 * prototypes
 */
/* static MJR */ int bounce_error_event(struct snd_seq_client *client,
			      struct snd_seq_event *event,
			      int err, int atomic, int hop);
/* static MJR */ int snd_seq_deliver_single_event(struct snd_seq_client *client,
					struct snd_seq_event *event,
...
static inline /*mm_segment_t*/ unsigned long snd_enter_user(void) // MJR
{
...
/*
 */
/* static MJR */ inline unsigned short snd_seq_file_flags(struct file *file)
{
...
/* static MJR */ inline int snd_seq_write_pool_allocated(struct snd_seq_client *client)
{
	return snd_seq_total_cells(client->pool) > 0;
}

/* return pointer to client structure for specified id */
/* static MJR */ struct snd_seq_client *clientptr(int clientid)
{
...
/* static MJR */ void usage_alloc(struct snd_seq_usage *res, int num)
{
	res->cur += num;
	if (res->cur > res->peak)
		res->peak = res->cur;
...
/* static MJR */ void usage_free(struct snd_seq_usage *res, int num)
{
	res->cur -= num;
}

/* initialise data structures */
int /* __init MJR */  client_init_data(void)
{
...
/* static MJR */ struct snd_seq_client *seq_create_client1(int client_index, int poolsize)
{
	unsigned long flags;
	int c;
	struct snd_seq_client *client;
...
/* static MJR */ int seq_free_client1(struct snd_seq_client *client)
{
	unsigned long flags;
...
/* static MJR */ void seq_free_client(struct snd_seq_client * client)
{
	mutex_lock(&register_mutex);
	switch (client->type) {
	case NO_CLIENT:
		snd_mprintk(KERN_WARNING "Seq: Trying to free unused client %d\n", // MJR
			   client->number);
		break;
	case USER_CLIENT:
	case KERNEL_CLIENT:
	...
	default:
		snd_mprintk(KERN_ERR "Seq: Trying to free client %d with undefined type = %d\n", // MJR
...
/* static MJR */ int snd_seq_open(struct inode *inode, struct file *file)
{
...
/* static MJR */ int snd_seq_release(struct inode *inode, struct file *file)
{
 ...
 */
/* static MJR */ ssize_t snd_seq_read(struct file *file,
 ...
 */
/* static MJR */ int check_port_perm(struct snd_seq_client_port *port, unsigned int flags)
{
 ...
 */
/* static MJR */ struct snd_seq_client *get_event_dest_client(struct snd_seq_event *event,
						    int filter)
{
 ...
 */
/* static MJR */ int update_timestamp_of_queue(struct snd_seq_event *event,
 ...
 */
/* static MJR */ int deliver_to_subscribers(struct snd_seq_client *client,
				  struct snd_seq_event *event,
				  int atomic, int hop)
{
 ...
 */
/* static MJR */ int port_broadcast_event(struct snd_seq_client *client,
				struct snd_seq_event *event,
				int atomic, int hop)
{
	int num_ev = 0, err = 0;
 ...
 */
/* static MJR */ int broadcast_event(struct snd_seq_client *client,
...
/* static MJR */ int multicast_event(struct snd_seq_client *client, struct snd_seq_event *event,
			   int atomic, int hop)
{
 ...
 */
/* static MJR */ int snd_seq_deliver_event(struct snd_seq_client *client, struct snd_seq_event *event,
				 int atomic, int hop)
{
	int result;
 ...
 * available.
 */
/* static MJR */ int snd_seq_client_enqueue_event(struct snd_seq_client *client,
					struct snd_seq_event *event,
 ...
 */
/* static MJR */ int check_event_type_and_length(struct snd_seq_event *ev)
{
 ...
 */
/* static MJR */ ssize_t snd_seq_write(struct file *file,
 ...
 * handle polling
 */
/* static MJR */ unsigned int snd_seq_poll(struct file *file, poll_table * wait)
{
	struct snd_seq_client *client = file->private_data;
	unsigned int mask = 0;
...
/* SYSTEM_INFO ioctl() */
/* static MJR */ int snd_seq_ioctl_system_info(struct snd_seq_client *client, void __user *arg)
{
...
/* RUNNING_MODE ioctl() */
/* static MJR */ int snd_seq_ioctl_running_mode(struct snd_seq_client *client, void __user *arg)
{
...
/* CLIENT_INFO ioctl() */
/* static MJR */ void get_client_info(struct snd_seq_client *cptr,
...
/* static MJR */ int snd_seq_ioctl_get_client_info(struct snd_seq_client *client,
					 void __user *arg)
{
	struct snd_seq_client *cptr;
...
/* CLIENT_INFO ioctl() */
/* static MJR */ int snd_seq_ioctl_set_client_info(struct snd_seq_client *client,
					 void __user *arg)
{
	struct snd_seq_client_info client_info;
	...
	if (client_info.name[0])
		strncpy(client->name, client_info.name, sizeof(client->name)); // MJR
 ...
 * CREATE PORT ioctl() 
 */
/* static MJR */ int snd_seq_ioctl_create_port(struct snd_seq_client *client,
				     void __user *arg)
{
	struct snd_seq_client_port *port;
 ...
 * DELETE PORT ioctl() 
 */
/* static MJR */ int snd_seq_ioctl_delete_port(struct snd_seq_client *client,
				     void __user *arg)
{
	struct snd_seq_port_info info;
	int err;
 ...
 */
/* static MJR */ int snd_seq_ioctl_get_port_info(struct snd_seq_client *client,
				       void __user *arg)
{
	struct snd_seq_client *cptr;
	struct snd_seq_client_port *port;
 ...
 */
/* static MJR */ int snd_seq_ioctl_set_port_info(struct snd_seq_client *client,
				       void __user *arg)
{
	struct snd_seq_client_port *port;
	struct snd_seq_port_info info;
...
/* static MJR */ int check_subscription_permission(struct snd_seq_client *client,
 ...
 */
/* static MJR */ int snd_seq_ioctl_subscribe_port(struct snd_seq_client *client,
					void __user *arg)
{
	int result = -EINVAL;
 ...
 */
/* static MJR */ int snd_seq_ioctl_unsubscribe_port(struct snd_seq_client *client,
					  void __user *arg)
{
	int result = -ENXIO;
	struct snd_seq_client *receiver = NULL, *sender = NULL;
...
/* CREATE_QUEUE ioctl() */
/* static MJR */ int snd_seq_ioctl_create_queue(struct snd_seq_client *client,
				      void __user *arg)
{
	struct snd_seq_queue_info info;
	int result;
	struct snd_seq_queue *q;
        char temp[256]; // For snprintf workaround
	...
	/* set queue name */
		...
		snprintf(info.name, sizeof(info.name), "Queue-%d", q->queue);
            */
            ...
            sprintf(temp, "Queue-%d", q->queue);
            memcpy (info.name, temp, sizeof(info.name));
            info.name[sizeof(info.name) - 1] = 0;
        } // MJR <---------------------
        
	strncpy(q->name, info.name, sizeof(q->name)); // MJR
	queuefree(q);
...
/* DELETE_QUEUE ioctl() */
/* static MJR */ int snd_seq_ioctl_delete_queue(struct snd_seq_client *client,
				      void __user *arg)
{
	struct snd_seq_queue_info info;
...
/* static MJR */ int snd_seq_ioctl_get_queue_info(struct snd_seq_client *client,
					void __user *arg)
{
	struct snd_seq_queue_info info;
	struct snd_seq_queue *q;
	...
	info.owner = q->owner;
	info.locked = q->locked;
	strncpy(info.name, q->name, sizeof(info.name)); // MJR
	queuefree(q);
...
/* static MJR */ int snd_seq_ioctl_set_queue_info(struct snd_seq_client *client,
					void __user *arg)
{
	struct snd_seq_queue_info info;
	struct snd_seq_queue *q;
...
/* static MJR */ int snd_seq_ioctl_get_named_queue(struct snd_seq_client *client, void __user *arg)
{
	struct snd_seq_queue_info info;
	struct snd_seq_queue *q;
...
/* static MJR */ int snd_seq_ioctl_get_queue_status(struct snd_seq_client *client,
					  void __user *arg)
{
...
/* static MJR */ int snd_seq_ioctl_get_queue_tempo(struct snd_seq_client *client,
					 void __user *arg)
{
...
// EXPORT_SYMBOL(snd_seq_set_queue_tempo); // MJR

/* static MJR */ int snd_seq_ioctl_set_queue_tempo(struct snd_seq_client *client,
					 void __user *arg)
{
	int result;
	struct snd_seq_queue_tempo tempo;
...
/* static MJR */ int snd_seq_ioctl_get_queue_timer(struct snd_seq_client *client,
					 void __user *arg)
{
...
/* static MJR */ int snd_seq_ioctl_set_queue_timer(struct snd_seq_client *client,
					 void __user *arg)
{
	int result = 0;
	struct snd_seq_queue_timer timer;
...
/* static MJR */ int snd_seq_ioctl_get_queue_client(struct snd_seq_client *client,
					  void __user *arg)
{
...
/* static MJR */ int snd_seq_ioctl_set_queue_client(struct snd_seq_client *client,
					  void __user *arg)
{
	int err;
	struct snd_seq_queue_client info;
...
/* static MJR */ int snd_seq_ioctl_get_client_pool(struct snd_seq_client *client,
					 void __user *arg)
{
...
/* static MJR */ int snd_seq_ioctl_set_client_pool(struct snd_seq_client *client,
					 void __user *arg)
{
	struct snd_seq_client_pool info;
	int rc;
...
/* REMOVE_EVENTS ioctl() */
/* static MJR */ int snd_seq_ioctl_remove_events(struct snd_seq_client *client,
				       void __user *arg)
{
 ...
 */
/* static MJR */ int snd_seq_ioctl_get_subscription(struct snd_seq_client *client,
					  void __user *arg)
{
	int result;
 ...
 */
/* static MJR */ int snd_seq_ioctl_query_subs(struct snd_seq_client *client,
				    void __user *arg)
{
	int result = -ENXIO;
 ...
 * query next client
 */
/* static MJR */ int snd_seq_ioctl_query_next_client(struct snd_seq_client *client,
					   void __user *arg)
{
	struct snd_seq_client *cptr = NULL;
	struct snd_seq_client_info info;
 ...
 * query next port
 */
/* static MJR */ int snd_seq_ioctl_query_next_port(struct snd_seq_client *client,
					 void __user *arg)
{
	struct snd_seq_client *cptr;
	struct snd_seq_client_port *port = NULL;
...
/* static MJR */ int snd_seq_do_ioctl(struct snd_seq_client *client, unsigned int cmd,
			    void __user *arg)
{
...
/* static MJR */ long snd_seq_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	struct snd_seq_client *client = file->private_data;
...
// EXPORT_SYMBOL(snd_seq_create_kernel_client); // MJR
...
// EXPORT_SYMBOL(snd_seq_delete_kernel_client); // MJR

/* skeleton to enqueue event, called from snd_seq_kernel_client_enqueue
 * and snd_seq_kernel_client_enqueue_blocking
 */
/* static MJR */ int kernel_client_enqueue(int client, struct snd_seq_event *ev,
				 struct file *file, int blocking,
				 int atomic, int hop)
{
	struct snd_seq_client *cptr;
...
// EXPORT_SYMBOL(snd_seq_kernel_client_enqueue); // MJR
...
// EXPORT_SYMBOL(snd_seq_kernel_client_enqueue_blocking); // MJR
...
// EXPORT_SYMBOL(snd_seq_kernel_client_dispatch); // MJR
...
// EXPORT_SYMBOL(snd_seq_kernel_client_ctl); // MJR
...
// EXPORT_SYMBOL(snd_seq_kernel_client_write_poll); // MJR
 ...
 *  /proc interface
 */
/* static MJR */ void snd_seq_info_dump_subscribers(struct snd_info_buffer *buffer,
					  struct snd_seq_port_subs_info *group,
					  int is_src, char *msg)
{
	struct list_head *p;
...
/* static MJR */ void snd_seq_info_dump_ports(struct snd_info_buffer *buffer,
				    struct snd_seq_client *client)
{
 ...
 */
int /* __init MJR */  snd_sequencer_device_init(void)
{
	int err;
