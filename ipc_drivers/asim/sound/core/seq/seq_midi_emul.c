...
/* static MJR */ void note_off(struct snd_midi_op *ops, void *drv,
		     struct snd_midi_channel *chan,
		     int note, int vel);
/* static MJR */ void do_control(struct snd_midi_op *ops, void *private,
		       struct snd_midi_channel_set *chset,
		       struct snd_midi_channel *chan,
		       int control, int value);
/* static MJR */ void rpn(struct snd_midi_op *ops, void *drv, struct snd_midi_channel *chan,
		struct snd_midi_channel_set *chset);
/* static MJR */ void nrpn(struct snd_midi_op *ops, void *drv, struct snd_midi_channel *chan,
		 struct snd_midi_channel_set *chset);
/* static MJR */ void sysex(struct snd_midi_op *ops, void *private, unsigned char *sysex,
		  int len, struct snd_midi_channel_set *chset);
/* static MJR */ void all_sounds_off(struct snd_midi_op *ops, void *private,
			   struct snd_midi_channel *chan);
/* static MJR */ void all_notes_off(struct snd_midi_op *ops, void *private,
			  struct snd_midi_channel *chan);
/* static MJR */ void snd_midi_reset_controllers(struct snd_midi_channel *chan);
/* static MJR */ void reset_all_channels(struct snd_midi_channel_set *chset);
 ...
 */
/* static MJR */ void snd_midi_channel_init(struct snd_midi_channel *p, int n)
{
	if (p == NULL)
		return;
 ...
 */
/* static MJR */ struct snd_midi_channel *snd_midi_channel_init_set(int n)
{
	struct snd_midi_channel *chan;
	int  i;
...
/* static MJR */ int /* __init MJR */  alsa_seq_midi_emul_init(void)
{
	return 0;
}

/* static MJR */ void __exit alsa_seq_midi_emul_exit(void)
{
}

// module_init(alsa_seq_midi_emul_init) // MJR
// module_exit(alsa_seq_midi_emul_exit) // MJR

// EXPORT_SYMBOL(snd_midi_process_event); // MJR
// EXPORT_SYMBOL(snd_midi_channel_set_clear); // MJR
// EXPORT_SYMBOL(snd_midi_channel_alloc_set); // MJR
// EXPORT_SYMBOL(snd_midi_channel_free_set); // MJR
