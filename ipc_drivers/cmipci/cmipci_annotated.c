...
static int (__attribute__((noderef, address_space(2))) index)[SNDRV_CARDS] = SNDRV_DEFAULT_IDX;	/* Index 0-MAX */ // MJR
static char *(__attribute__((noderef, address_space(2))) id)[SNDRV_CARDS] = SNDRV_DEFAULT_STR;	/* ID for this card */ // MJR
static int (__attribute__((noderef, address_space(2))) enable)[SNDRV_CARDS] = SNDRV_DEFAULT_ENABLE_PNP;	/* Enable switches */ // MJR
static long (__attribute__((noderef, address_space(2))) mpu_port)[SNDRV_CARDS]; // MJR
static long (__attribute__((noderef, address_space(2))) fm_port)[SNDRV_CARDS] = {[0 ... (SNDRV_CARDS-1)]=1}; // MJR
static int (__attribute__((noderef, address_space(2))) soft_ac3)[SNDRV_CARDS] = {[0 ... (SNDRV_CARDS-1)]=1}; // MJR
#ifdef SUPPORT_JOYSTICK
static int (__attribute__((noderef, address_space(2))) joystick_port)[SNDRV_CARDS]; // MJR
#endif
...
static const struct cmipci_mixer_auto_switches (__attribute__((noderef, address_space(2))) cm_saved_mixer)[] = { // MJR
...
static struct snd_pcm_hw_constraint_list __attribute__((noderef, address_space(2))) hw_constraints_channels_4 = { // MJR
	.count = 3,
	.list = hw_channels,
	.mask = 0,
};
static struct snd_pcm_hw_constraint_list __attribute__((noderef, address_space(2))) hw_constraints_channels_6 = { // MJR
	.count = 4,
	.list = hw_channels,
	.mask = 0,
};
static struct snd_pcm_hw_constraint_list __attribute__((noderef, address_space(2))) hw_constraints_channels_8 = { // MJR
	.count = 5,
	.list = hw_channels,
	.mask = 0,
};
...
static struct __attribute__((noderef, address_space(2))) snd_kcontrol_new snd_cmipci_spdif_default __devinitdata = // MJR
{
...
static struct __attribute__((noderef, address_space(2))) snd_kcontrol_new snd_cmipci_spdif_mask __devinitdata = // MJR
{
...
static struct snd_kcontrol_new __attribute__((noderef, address_space(2))) snd_cmipci_spdif_stream __devinitdata = // MJR
{
...
static struct snd_pcm_hardware __attribute__((noderef, address_space(2))) snd_cmipci_playback = // MJR
{
...
static struct snd_pcm_hardware __attribute__((noderef, address_space(2))) snd_cmipci_capture = // MJR
{
	.info =			(SNDRV_PCM_INFO_MMAP | SNDRV_PCM_INFO_INTERLEAVED |
				 SNDRV_PCM_INFO_BLOCK_TRANSFER | SNDRV_PCM_INFO_PAUSE |
				 SNDRV_PCM_INFO_RESUME | SNDRV_PCM_INFO_MMAP_VALID),
...
static struct snd_pcm_hardware __attribute__((noderef, address_space(2))) snd_cmipci_playback2 = // MJR
{
	.info =			(SNDRV_PCM_INFO_MMAP | SNDRV_PCM_INFO_INTERLEAVED |
				 SNDRV_PCM_INFO_BLOCK_TRANSFER | SNDRV_PCM_INFO_PAUSE |
				 SNDRV_PCM_INFO_RESUME | SNDRV_PCM_INFO_MMAP_VALID),
...
static struct snd_pcm_hardware __attribute__((noderef, address_space(2))) snd_cmipci_playback_spdif = // MJR
{
	.info =			(SNDRV_PCM_INFO_MMAP | SNDRV_PCM_INFO_INTERLEAVED |
				 SNDRV_PCM_INFO_BLOCK_TRANSFER | SNDRV_PCM_INFO_PAUSE |
				 SNDRV_PCM_INFO_RESUME | SNDRV_PCM_INFO_MMAP_VALID),
...
static struct snd_pcm_hardware __attribute__((noderef, address_space(2))) snd_cmipci_playback_iec958_subframe = // MJR
{
	.info =			(SNDRV_PCM_INFO_MMAP | SNDRV_PCM_INFO_INTERLEAVED |
				 SNDRV_PCM_INFO_BLOCK_TRANSFER | SNDRV_PCM_INFO_PAUSE |
				 SNDRV_PCM_INFO_RESUME | SNDRV_PCM_INFO_MMAP_VALID),
...
static struct snd_pcm_hardware __attribute__((noderef, address_space(2))) snd_cmipci_capture_spdif = // MJR
{
	.info =			(SNDRV_PCM_INFO_MMAP | SNDRV_PCM_INFO_INTERLEAVED |
				 SNDRV_PCM_INFO_BLOCK_TRANSFER | SNDRV_PCM_INFO_PAUSE |
				 SNDRV_PCM_INFO_RESUME | SNDRV_PCM_INFO_MMAP_VALID),
...
static unsigned int (__attribute__((noderef, address_space(2))) rate_constraints)[] = { 5512, 8000, 11025, 16000, 22050,
                                                                                        32000, 44100, 48000, 88200, 96000, 128000 }; // MJR
static struct snd_pcm_hw_constraint_list __attribute__((noderef, address_space(2))) hw_constraints_rates = { // MJR
...
static struct snd_pcm_ops __attribute__((noderef, address_space(2))) snd_cmipci_playback_ops = { // MJR
...
static struct snd_pcm_ops __attribute__((noderef, address_space(2))) snd_cmipci_capture_ops = { // MJR
...
static struct snd_pcm_ops __attribute__((noderef, address_space(2))) snd_cmipci_playback2_ops = { // MJR
...
static struct snd_pcm_ops __attribute__((noderef, address_space(2))) snd_cmipci_playback_spdif_ops = { // MJR
...
static struct snd_pcm_ops __attribute__((noderef, address_space(2))) snd_cmipci_capture_spdif_ops = { // MJR
...
#define DEFINE_SWITCH_ARG(sname, xreg, xmask, xmask_on, xis_byte, xac3) \
    static struct cmipci_switch_args __attribute__((noderef, address_space(2))) cmipci_switch_arg_##sname = { /* MJR */ \
  .reg = xreg, \
  .mask = xmask, \
  .mask_on = xmask_on, \
  .is_byte = xis_byte, \
...
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_cmipci_mixer_switches)[] __devinitdata = {
...
static struct snd_kcontrol_new __attribute__((noderef, address_space(2))) snd_cmipci_nomulti_switch __devinitdata = // MJR
    DEFINE_MIXER_SWITCH("Exchange DAC", exchange_dac);

/* only for CM8738 */
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_cmipci_8738_mixer_switches)[] __devinitdata = {
...
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_cmipci_old_mixer_switches)[] __devinitdata = {
...
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_cmipci_extra_mixer_switches)[] __devinitdata = {
...
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_cmipci_modem_switch) __devinitdata =
				       ...
				       int dev, struct cmipci **rcmipci)
{
	...
	static struct pci_device_id (__attribute__((noderef, address_space(2))) intel_82437vx)[] = { // MJR
		{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_82437VX) },
                { 0, 0, 0, 0, 0, 0, 0 } // MJR Added this to workaround CIL bug
		// { }, // MJR was this
	};
