...
struct snd_ca_midi {
    ...
    struct snd_rawmidi_substream *__attribute__((recursive))substream_input; // MJR
    struct snd_rawmidi_substream *__attribute__((recursive))substream_output; // MJR

    void * __attribute__((recursive)) dev_id; // MJR
