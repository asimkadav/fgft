...
#include <sound/timer.h> // MJR
#include <linux/proc_fs.h> // MJR
#include "modif_annots.h" // MJR

// MJR Moved this code up slave_vols slave_sws ------------>
static char * (__attribute__((noderef, address_space(2))) slave_vols[]) __devinitdata = { // MJR
...
static char * (__attribute__((noderef, address_space(2))) slave_sws)[] __devinitdata = { // MJR
...
static struct snd_kcontrol_new __attribute__((noderef, address_space(2))) snd_ca0106_capture_mic_line_in __devinitdata = // MJR
{
...
static struct snd_kcontrol_new __attribute__((noderef, address_space(2))) snd_ca0106_capture_line_in_side_out __devinitdata = // MJR
{
	.iface =	SNDRV_CTL_ELEM_IFACE_MIXER,
...
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_ca0106_volume_ctls)[] __devinitdata = {
...
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_ca0106_volume_i2c_adc_ctls)[] __devinitdata = {
...
static struct snd_kcontrol_new (__attribute__((noderef, address_space(2))) snd_ca0106_volume_spi_dac_ctls)[]
__devinitdata = {
...
// MJR Moved the following code ca0106_remove_ctls ca0106_rename_ctls --------->
static char * (__attribute__((noderef, address_space(2))) ca0106_remove_ctls)[] = { // MJR
...
static char * (__attribute__((noderef, address_space(2))) ca0106_rename_ctls)[] = { // MJR
...
/*	static char *ca0106_remove_ctls[] = { // MJR Moved up
		"Master Mono Playback Switch",
		"Master Mono Playback Volume",
		"3D Control - Switch",
		"3D Control Sigmatel - Depth",
...
static struct ca0106_vol_tbl (__attribute__((noderef, address_space(2))) saved_volumes)[NUM_SAVED_VOLUMES] = {
	{ CONTROL_FRONT_CHANNEL, PLAYBACK_VOLUME2 },
	{ CONTROL_REAR_CHANNEL, PLAYBACK_VOLUME2 },
	{ CONTROL_CENTER_LFE_CHANNEL, PLAYBACK_VOLUME2 },
	{ CONTROL_UNKNOWN_CHANNEL, PLAYBACK_VOLUME2 },
