...
struct snd_ca0106_pcm {
    struct snd_ca0106 * __attribute__((recursive)) emu; // MJR
    struct snd_pcm_substream *__attribute__((recursive)) substream; // MJR
        int channel_id;
...
struct snd_ca0106 {
    ...
    struct pci_dev * __attribute__((recursive)) pci; // MJR
