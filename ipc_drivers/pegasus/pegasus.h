...
typedef struct pegasus {
	struct usb_device	*  __attribute__((noderef, address_space(2))) usb; //ASIM 
	struct usb_interface	*  __attribute__((noderef, address_space(2)))intf; //ASIM
	...
	struct urb		*  __attribute__((noderef, address_space(2)))  ctrl_urb, * __attribute__((noderef, address_space(2)))  rx_urb; //ASIM
	struct urb		 *  __attribute__((noderef, address_space(2)))  tx_urb, *  __attribute__((noderef, address_space(2)))  intr_urb; //ASIM
	struct sk_buff		*  __attribute__((noderef, address_space(2)))  rx_pool[RX_SKBS]; //ASIM
	struct sk_buff		* __attribute__((noderef, address_space(2)))  rx_skb; //ASIM
