...
typedef struct pegasus {
	...
	struct mii_if_info * __attribute__((noderef, address_space(2))) mii;
	unsigned		flags;
	unsigned		features;
	u32			msg_enable;
	u32			wolopts;
	...
	struct urb		*__attribute__((noderef, address_space(2))) ctrl_urb, * __attribute__((noderef, address_space(2)))rx_urb, * __attribute__((noderef, address_space(2))) tx_urb, * __attribute__((noderef, address_space(2)))intr_urb;
	struct sk_buff		* __attribute__((noderef, address_space(2))) rx_pool[RX_SKBS];
