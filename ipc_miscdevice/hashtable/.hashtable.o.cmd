cmd_/scratch/sym/ipc_miscdevice/hashtable/hashtable.o := gcc -Wp,-MD,/scratch/sym/ipc_miscdevice/hashtable/.hashtable.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/4.1.2/include -Iinclude -Iinclude2 -I/scratch/sym/linux-2.6.29/include -I/scratch/sym/linux-2.6.29/arch/x86/include -include include/linux/autoconf.h   -I/scratch/sym/ipc_miscdevice -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Os -m64 -mtune=generic -mno-red-zone -mcmodel=kernel -funit-at-a-time -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow  -I/scratch/sym/linux-2.6.29/arch/x86/include/asm/mach-default -Iarch/x86/include/asm/mach-default -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls -Wdeclaration-after-statement -Wno-pointer-sign -fwrapv -Wno-attributes -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(hashtable)"  -D"KBUILD_MODNAME=KBUILD_STR(mischelp)"  -c -o /scratch/sym/ipc_miscdevice/hashtable/hashtable.o /scratch/sym/ipc_miscdevice/hashtable/hashtable.c

deps_/scratch/sym/ipc_miscdevice/hashtable/hashtable.o := \
  /scratch/sym/ipc_miscdevice/hashtable/hashtable.c \
  /scratch/sym/ipc_miscdevice/hashtable/hashtable.h \
  /scratch/sym/ipc_miscdevice/hashtable/hashtable_private.h \
...
/scratch/sym/ipc_miscdevice/hashtable/hashtable.o: $(deps_/scratch/sym/ipc_miscdevice/hashtable/hashtable.o)
